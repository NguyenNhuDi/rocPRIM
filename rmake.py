...
def parse_args():
    ...
    parser.add_argument('-a', '--architecture', dest='gpu_architecture', required=False, default="gfx906,gfx1030,gfx1100,gfx1101,gfx1102,gfx1151,gfx1200,gfx1201", #:sramecc+:xnack-" ) #gfx1030" ) #gfx906" ) # gfx1030" )
